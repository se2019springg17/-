...
if ($_GET['action']=='add'){
	...
	$query = mysql_query("insert into apply (title,writer,pic,lanmu,content,user) values 	('{$_POST['title']}','{$_POST['writer']}','{$_FILES['file']['name']}','{$_POST['lanmu']}','{$_POST['content']}','{$_COOKIE['yhm']}')") or die(mysql_error());
